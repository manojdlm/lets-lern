...
import Logo from '../images/logo-lest-lern.png'
    ...
    return (
        ...
        <div className="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-4">
          <a href="./" className="flex items-center">
            <img
              src={Logo}
              className="h-8 mr-3 bg-slate-950"
              alt="Flowbite Logo"
            />
          ...
          >
            <ul className="font-medium flex flex-col p-4 md:p-0 mt-4 border border-gray-100 rounded-lg bg-gray-50 md:flex-row md:space-x-8 md:mt-0 md:border-0 md:bg-white dark:border-gray-700">
              ...
              <Link to='/registar'>
              <li>
                <button className="   bg-blue-500  py-1 px-2 rounded-md text-white  ">Sign-up</button>
              </li>
              </Link>
              <li>
                <Link to='/login'>
                <button className=" bg-blue-500  py-1 px-2  text-white  rounded-md">Singin</button>
                </Link>
              </li>
            </ul>
          </div>
